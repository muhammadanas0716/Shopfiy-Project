...
export default function LicensePlatesPage() {
  const product = PRODUCTS.plates;
  const { addItem } = useCart();
  const [variantId, setVariantId] = useState(product.variants[0]?.id ?? "6");
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li>
              <span className="text-red-600">License Plate Posters</span>
            </li>
          </ol>
        </nav>
            ...
            <div className="p-10 flex flex-col justify-center">
              ...
              <div className="prose prose-gray max-w-none mb-8">
                <p className="text-lg text-gray-700 mb-6">
                  Bold, clean, iconic License Plates Poster — premium print to transform any space into an automotive art wall.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4 sans-font">Product Highlights</h3>
                <div className="space-y-3 text-gray-700">
                  <div><strong>Premium Quality:</strong> High-resolution printing on premium paper</div>
                  <div><strong>Perfect Size:</strong> Ideal dimensions for any wall space</div>
                  <div><strong>Vibrant Colors:</strong> Rich, long-lasting colors</div>
                  <div><strong>Easy Installation:</strong> Ready to frame and hang</div>
                </div>
              </div>
